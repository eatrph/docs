...
Learn how Bringit works - whether you are the customer or the personal shopper.

<AccordionGroup>
  <Accordion title="What is Bringit" icon="question">
    Bringit is a crowdsourced marketplace for buying hard to find things through the help of personal shoppers, who can get you the items you love for a small fee called a "Tip." 
  ...
  <Accordion title="Customer vs Personal Shopper" icon="people-carry-box">
  ...
  <Accordion title="What are the safety features of Bringit" icon="key">
...
<AccordionGroup>
  <Accordion title="Posting your first request" icon="newspaper">
